import { Breadcrumb, BreadcrumbHint } from '@sentry/types/src/breadcrumb';
import { Client } from '@sentry/types/src/client';
import { Event, EventHint } from '@sentry/types/src/event';
import { Extra, Extras } from '@sentry/types/src/extra';
import { Integration, IntegrationClass } from '@sentry/types/src/integration';
import { Primitive } from '@sentry/types/src/misc';
import { Scope } from '@sentry/types/src/scope';
import { Session, SessionContext } from '@sentry/types/src/session';
import { Severity } from '@sentry/types/src/severity';
import { Span, SpanContext } from '@sentry/types/src/span';
import { CustomSamplingContext, Transaction, TransactionContext } from '@sentry/types/src/transaction';
import { User } from '@sentry/types/src/user';
/**
