import { Applicative, Applicative1, Applicative2, Applicative2C, Applicative3C, ApplicativeComposition, ApplicativeComposition11, ApplicativeComposition21, ApplicativeComposition2C1, ApplicativeComposition3C1 } from 'fp-ts/lib/Applicative';
import { Functor, Functor1, Functor2, Functor2C, Functor3C } from 'fp-ts/lib/Functor';
import { HKT, Kind, Kind2, Kind3, URIS, URIS2, URIS3 } from './HKT';
import { Monad, Monad1, Monad2, Monad2C, Monad3C } from 'fp-ts/lib/Monad';
import { Option, URI } from 'fp-ts/lib/Option';
