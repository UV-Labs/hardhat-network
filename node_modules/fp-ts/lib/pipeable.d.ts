import { Alt, Alt1, Alt2, Alt2C, Alt3, Alt4 } from 'fp-ts/lib/Alt';
import { Apply, Apply1, Apply2, Apply2C, Apply3, Apply4 } from 'fp-ts/lib/Apply';
import { Bifunctor, Bifunctor2, Bifunctor3, Bifunctor4 } from 'fp-ts/lib/Bifunctor';
import { Chain, Chain1, Chain2, Chain2C, Chain3, Chain4 } from 'fp-ts/lib/Chain';
import { Compactable, Compactable1, Compactable2, Compactable2C, Compactable3, Compactable4, Separated } from 'fp-ts/lib/Compactable';
import { Contravariant, Contravariant1, Contravariant2, Contravariant2C, Contravariant3, Contravariant4 } from 'fp-ts/lib/Contravariant';
import { Either } from 'fp-ts/lib/Either';
import { Extend, Extend1, Extend2, Extend2C, Extend3, Extend4 } from 'fp-ts/lib/Extend';
import { Filterable, Filterable1, Filterable2, Filterable2C, Filterable3, Filterable4 } from 'fp-ts/lib/Filterable';
import { FilterableWithIndex, FilterableWithIndex1, FilterableWithIndex2, FilterableWithIndex2C, FilterableWithIndex3, FilterableWithIndex4, PredicateWithIndex, RefinementWithIndex } from 'fp-ts/lib/FilterableWithIndex';
import { Foldable2v, Foldable2v1, Foldable2v2, Foldable2v2C, Foldable2v3, Foldable2v4 } from 'fp-ts/lib/Foldable2v';
import { FoldableWithIndex, FoldableWithIndex1, FoldableWithIndex2, FoldableWithIndex2C, FoldableWithIndex3, FoldableWithIndex4 } from 'fp-ts/lib/FoldableWithIndex';
import { Predicate, Refinement } from 'fp-ts/lib/function';
import { Functor, Functor1, Functor2, Functor2C, Functor3, Functor4 } from 'fp-ts/lib/Functor';
import { FunctorWithIndex, FunctorWithIndex1, FunctorWithIndex2, FunctorWithIndex2C, FunctorWithIndex3, FunctorWithIndex4 } from 'fp-ts/lib/FunctorWithIndex';
import { HKT, HKT2, Kind, Kind2, Kind3, Kind4, URIS, URIS2, URIS3, URIS4 } from './HKT';
import { Monoid } from 'fp-ts/lib/Monoid';
import { Option } from 'fp-ts/lib/Option';
import { Profunctor, Profunctor2, Profunctor2C, Profunctor3, Profunctor4 } from 'fp-ts/lib/Profunctor';
import { Semigroupoid, Semigroupoid2, Semigroupoid2C, Semigroupoid3, Semigroupoid4 } from 'fp-ts/lib/Semigroupoid';
import { MonadThrow, MonadThrow3, MonadThrow2C, MonadThrow2, MonadThrow4, MonadThrow1 } from 'fp-ts/lib/MonadThrow';
/**
 * @since 1.19.0
 */
