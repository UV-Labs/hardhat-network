...
declare const alt: <A>(that: () => A[]) => (fa: A[]) => A[], ap: <A>(fa: A[]) => <B>(fab: ((a: A) => B)[]) => B[], apFirst: <B>(fb: B[]) => <A>(fa: A[]) => A[], apSecond: <B>(fb: B[]) => <A>(fa: A[]) => B[], chain: <A, B>(f: (a: A) => B[]) => (ma: A[]) => B[], chainFirst: <A, B>(f: (a: A) => B[]) => (ma: A[]) => A[], duplicate: <A>(ma: A[]) => A[][], extend: <A, B>(f: (fa: A[]) => B) => (ma: A[]) => B[], filterMap: <A, B>(f: (a: A) => Option<B>) => (fa: A[]) => B[], filterMapWithIndex: <A, B>(f: (i: number, a: A) => Option<B>) => (fa: A[]) => B[], filterWithIndex: {
    <A, B extends A>(refinementWithIndex: import("fp-ts/lib/FilterableWithIndex").RefinementWithIndex<number, A, B>): (fa: A[]) => B[];
    <A>(predicateWithIndex: import("fp-ts/lib/FilterableWithIndex").PredicateWithIndex<number, A>): (fa: A[]) => A[];
    ...
    <A, B extends A>(refinementWithIndex: import("fp-ts/lib/FilterableWithIndex").RefinementWithIndex<number, A, B>): (fa: A[]) => Separated<A[], B[]>;
    <A>(predicateWithIndex: import("fp-ts/lib/FilterableWithIndex").PredicateWithIndex<number, A>): (fa: A[]) => Separated<A[], A[]>;
